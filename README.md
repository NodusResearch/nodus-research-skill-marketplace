...
<thead><tr><th width="190">App / skill</th><th width="125">Contributor</th><th width="505">Description</th></tr></thead>
<tbody>
<tr><td><a href="anatomy-visualization/">Anatomy Visualization</a></td><td><a href="https://github.com/Drakonis96">@Drakonis96</a></td><td>Development 1.1.0 atlas: deterministic SVG, packaged 3D reference meshes and curated English/Spanish semantic queries. Requires the companion Nodus integration; publication is gated.</td></tr>
